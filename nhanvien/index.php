...
<head>
    ...
    <body>
        ...
        <div id="loginbox">            
            ...
            <div class="control-group normal_text"> <h3><img src="../style/img/demo/logo.png" alt="Logo" /></h3></div>
                ...
                <div class="form-actions center">
                    <button type="submit" class="btn btn-block btn-large btn-info" title="Log In" name="login" value="Nhân viên Login">Đăng nhập</button>
                </div>
            </form>
            <?php
