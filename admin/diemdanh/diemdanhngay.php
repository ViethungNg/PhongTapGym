...
<?php $page="diemdanhngay"; include '../includes/sidebar.php'?>
...
<div id="content">
  <div id="content-header">
    ...
    <h1 class="text-center">Quản lý điểm danh hôm nay<i class="fas fa-group"></i></h1>
  </div>
    ...
    <div class="row-fluid">
      ...
      <div class='widget-box'>
          ...
          <table class='table table-bordered table-hover'>
             ...
             <?php
                    $Ngaydd = date('Y-m-j');
                    $qry="select *from diemdanh dd LEFT JOIN khachhang m on dd.user_id = m.user_id LEFT JOIN dichvu d ON m.id = d.id where DATEDIFF(m.Ngaykt, CURDATE()) >= 0 AND dd.kiemtra = '$Ngaydd'";
           ...
           <tbody>               
                ...
                <td><div class='text-center'><?php echo $row['Ngaydd']; ?></div></td>
