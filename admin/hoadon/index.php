...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <div class="row-fluid">
	  ...
	  <?php
      $qry="SELECT khachhang.ngaythue,khachhang.ngayktthue,khachhang.user_id,dichvu.id, khachhang.Loinhac,khachhang.Hoten, khachhang.Trangthai,khachhang.Kehoach, khachhang.Diachi,dichvu.Tendv, khachhang.Tongtien, khachhang.Diachi, nhanvien.Hoten as HT FROM khachhang LEFT join dichvu on khachhang.id = dichvu.id LEFT JOIN nhanvien on khachhang.id_nhanvien = nhanvien.id_nhanvien";
      $cnt = 1;
        $result=mysqli_query($con,$qry);
          ...
          echo"<table class='table table-bordered data-table table-hover'>
            ...
            <tbody>                
                ...
                <td><div class='text-center'><?php echo $row['HT']?></div></td>
                <td><div class='text-center'><?php echo $soThangThue?> tháng</div></td>                
            ...
            ?>
                <td><div class='text-center'><a href='nhacnho.php?id=<?php echo $row['user_id']?>'><button class='btn btn-danger btn' <?php echo ($row['Loinhac'] == 1 || $row['Trangthai'] == 1 ? "disabled" : ""); ?>>Nhắc nhở <i class="fas fa-bullhorn"></i></button></a></div></td>
              </tbody>
          <?php $cnt++; }
